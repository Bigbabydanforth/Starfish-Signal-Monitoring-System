...
function mapRecord(record) {
  return {
    ...
    email_2_subject:  record.get('Email 2 Subject')  || null,
    email_2_body:     record.get('Email 2 Body')     || null,
    email_3_subject:  record.get('Email 3 Subject')  || null,
    email_3_body:     record.get('Email 3 Body')     || null,
    email_4_subject:  record.get('Email 4 Subject')  || null,
    email_4_body:     record.get('Email 4 Body')     || null,
    email_5_subject:  record.get('Email 5 Subject')  || null,
    email_5_body:     record.get('Email 5 Body')     || null,
    email_6_subject:  record.get('Email 6 Subject')  || null,
    email_6_body:     record.get('Email 6 Body')     || null,
    email_7_subject:  record.get('Email 7 Subject')  || null,
    email_7_body:     record.get('Email 7 Body')     || null,
    email_8_subject:  record.get('Email 8 Subject')  || null,
    email_8_body:     record.get('Email 8 Body')     || null,
    email_9_subject:  record.get('Email 9 Subject')  || null,
    email_9_body:     record.get('Email 9 Body')     || null,
    email_10_subject: record.get('Email 10 Subject') || null,
    email_10_body:    record.get('Email 10 Body')    || null,
